...
@Autonomous(name="StarterBotPerimeterAuto", group="StarterBot")
//@Disabled
public class StarterBotPerimeterAuto extends OpMode
{
    ...
    double INCHES_TO_DRIVE_FROM_GOAL = 10;  // inches to drive from goal after launching balls in basic auto config
    double MOVE_FORWARDS = 32;
    double  ROBOT_ROTATION_ANGLE = 50;
    ...
    public void init() {
        ...
        autonomousState = AutonomousState.DRIVING_OFF_LINE; // quick change for Esquimalt Scrimmage 22 Nov 2026
    ...
    public void loop() {
        ...
        switch (autonomousState){
            ...
            case DRIVING_AWAY_FROM_GOAL:
                 ...
                 */
                if(drive(DRIVE_SPEED, -INCHES_TO_DRIVE_FROM_GOAL, DistanceUnit.INCH, 1)){
                    leftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    rightDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
            ...
            case ROTATING:
                if(alliance == Alliance.RED){
                    robotRotationAngle = ROBOT_ROTATION_ANGLE;
            ...
            case DRIVING_OFF_LINE:
                if(drive(DRIVE_SPEED, MOVE_FORWARDS, DistanceUnit.INCH, 1)){
